...
# Variables
IMAGE_NAME="mavrospy2-mocap"
IMAGE_TAG="latest"
DOCKERFILE_PATH="./Dockerfile"
CONTAINER_NAME="mavrospy2-mocap-container"
...
docker run -it --rm --net=host --ipc=host -e DISPLAY=$DISPLAY -v /tmp/.X11-unix:/tmp/.X11-unix -v ~/mavrospy/docker/mocap/cfg.yaml:/home/mocap/ros2_ws/src/motion_capture_tracking/motion_capture_tracking/config/cfg.yaml --name $CONTAINER_NAME $IMAGE_NAME:$IMAGE_TAG
