...
# Variables
IMAGE_NAME="mavrospy2-rpi"
IMAGE_TAG="latest"
DOCKERFILE_PATH="./Dockerfile"
CONTAINER_NAME="mavrospy2-rpi-container"
...
docker run -it --rm --name $CONTAINER_NAME --device=/dev/serial0 --net=host --ipc=host $IMAGE_NAME:$IMAGE_TAG
