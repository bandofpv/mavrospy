...
# Variables
IMAGE_NAME="mavrospy2-rpi-outdoor"
IMAGE_TAG="latest"
DOCKERFILE_PATH="./Dockerfile"
CONTAINER_NAME="mavrospy2-rpi-outdoor-container"
...
docker run -it --restart=always --name $CONTAINER_NAME --device=/dev/serial0 --ipc=host $IMAGE_NAME:$IMAGE_TAG
