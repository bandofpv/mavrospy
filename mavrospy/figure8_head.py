...
def fly_figure_eight(controller, width, length, altitude, resolution=360):
    ...
    for i in range(resolution):
        ...
        controller.goto_xyz_rpy(x, y, altitude, 0, 0, yaw, 1/20, isClose=False)
    controller.get_logger().info("Figure-eight head pattern complete")
...
def main():
    ...
    controller.get_logger().info("Starting figure-eight head pattern...")
