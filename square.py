...
def simple_demo():
    ...
    c.goto_xyz_rpy(0.4, 0.0, alt, 0, 0, -1 * c.pi_2, 3)
    rospy.loginfo("Waypoint 2: position control")
    c.goto_xyz_rpy(0.4, 0.0, alt, 0, 0, 0, 2)
    c.goto_xyz_rpy(0.4, 0.4, alt, 0, 0, 0, 3)
    rospy.loginfo("Waypoint 3: position control")
    c.goto_xyz_rpy(0.4, 0.4, alt, 0, 0, c.pi_2, 2)
    c.goto_xyz_rpy(0.0, 0.4, alt, 0, 0, c.pi_2, 3)
    rospy.loginfo("Waypoint 4: position control")
    c.goto_xyz_rpy(0.0, 0.4, alt, 0, 0, 2 * c.pi_2, 2)
